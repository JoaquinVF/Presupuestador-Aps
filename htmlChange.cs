...
namespace Presupuestador
{
    class htmlChange
    {
        ...
        public static void llenarHtml(string sCliente, string sPresupuesto, string sFecha, string sProyecto, string sMonto, string sMoneda, string sTimming, string sEntrega, string sCondiciones, string sEncabezado, string sCuerpo, string sImagen, string paths)//<NombreEscena> <Mail> <PuntosEstimados>
        {
